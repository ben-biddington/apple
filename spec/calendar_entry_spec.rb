...
describe CalendarEntry do
  ...
  it "you can parse from text, examples" do
    ...
    result.start.should === Date.new(2011, 8, 30)
  end
  ...
  it "another example" do
    ...
    result.start.should === Date.new(2011, 9, 8)    
    result.end.should === Date.new(2011, 9, 10)
  end

  it "tells you how long the period is it represents" do
    CalendarEntry.new(Date.new(2011, 9, 8)).duration_in_days.should === 1
    CalendarEntry.new(Date.new(2011, 9, 8), Date.new(2011, 9, 8)).duration_in_days.should === 1
    CalendarEntry.new(Date.new(2011, 9, 8), Date.new(2011, 9, 9)).duration_in_days.should === 2
    CalendarEntry.new(Date.new(2011, 9, 8), Date.new(2011, 9, 10)).duration_in_days.should === 3
  end
end
